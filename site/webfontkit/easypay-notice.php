<?php
  ...
  $secret     = 'X6KH7XAAE3G6XG7NGUL3JARBRAHP2L0YGP0IR0IVC3QNQ8TLF4AQWG4DT6QKD9LM';
...
//                                    VALUES (NULL,'$order_id','$easypay_notice','".$_SERVER['REMOTE_ADDR']."','$notice_response',NOW())";
//  @mysqli_query($db_link,$query);
  $query = "INSERT INTO `easypay_notices`(`notice_id`, `order_id`, `notice`, `notice_ipv4`, `notice_response`, `notice_date`) 
                                    VALUES (NULL,'$order_id','$easypay_notice_post','".$_SERVER['REMOTE_ADDR']."','$notice_response',NOW())";
  @mysqli_query($db_link,$query);
?>
