<?php
  ...
  if(isset($_POST['newsletter_email'])) {
    $newsletter_email = mysqli_real_escape_string($db_link, $_POST['newsletter_email']);
  }
  ...
  if(filter_var($newsletter_email, FILTER_VALIDATE_EMAIL)) {
    ...
    $query_subscribe = "INSERT INTO `email_campaign_list`(`campaign_list_id`, `campaign_id`, `email`, `date`) 
                                                  VALUES (NULL,'$campaign_id','$newsletter_email', NOW())";
