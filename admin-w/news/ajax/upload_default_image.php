<?php
  ...
  if(mysqli_num_rows($result_news_details) > 0) {
    ...
    $image_sidebar_thumb_name = $current_news_image_name."_sidebar_thumb.".$current_news_image_exstension;
    $image_sidebar_thumb = $upload_path.$image_sidebar_thumb_name;

    if(file_exists($image_sidebar_thumb)) unlink($image_sidebar_thumb);
  }
