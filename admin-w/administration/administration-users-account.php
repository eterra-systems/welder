<?php
  ...
  $page_title = $languages['header_administration_users_account'];
  ...
  <main>
    <div class="inside_container">
      <section id="breadcrumbs">
        ...
        <span>&raquo;</span>
        <?=$languages['header_administration_users_account'];?>
      </section>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th width="20%"><?=$languages['header_user_username'];?></th>
            <th width="10%"><?=$languages['header_user_password'];?></th>
            <th width="15%"><?=$languages['header_user_firstname'];?></th>
            <th width="15%"><?=$languages['header_user_lastname'];?></th>
            <th></th>
          </tr>
        </thead>
      </table>
...
?>
      <div id="user<?=$user_id; ?>" class="row_over">
        <table>
          <tbody>
            <tr>
              <td width="5%"><button class="btn_save" onClick="EditRestrictedUser('<?=$user_id; ?>')"><?=$languages['btn_save'];?></button></td>
