...
?>
    ...
    <div style="display:none;" id="modal_confirm" class="clearfix" title="<?=$languages['text_are_you_sure']?>">
      <p style="padding:0;margin:0;width:100%;float:left;"><?=$languages['delete_menu_link_note_warning']?></p>
    </div>
<?php
    }
    else {
?>
    <div class="add_new_form" class="row_over"> 
      <table>
        <tr class="even">
          <td width="5%"><button class="btn_save" onClick="AddMenuLinkNote()"><?=$languages['btn_save'];?></button></td>
          <td width="90%">
